  ...
  function init() {
    ...
    notice.innerHTML = `
      ...
      <div class="privacy-notice__body">
        ...
        <p class="privacy-notice__copy" id="privacy-notice-copy">We do not use cookies or similar technologies to track visitors. If you select “Okay”, we remember that choice on this device. If you sign in, essential cookies and security data keep your session working and protected.</p>
      ...
      <button class="privacy-notice__confirm" type="button">Okay <span aria-hidden="true">👍</span></button>
    `;
