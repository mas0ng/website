(function () {
  ...
  const SHARED_NAV_URL = "https://sharedassets.mas0ng.com/navbar.js?v=20260813-command-silo-orbit1";
  ...
  const legalLinks = [
    ...
    { id: "licences", label: "Licensing", href: SITE_ORIGIN + "/legal/licences.html", icon: "copyright" }
  ];
  ...
  function inferActive() {
    ...
    if (path.endsWith("/licences.html")) return "licences";
